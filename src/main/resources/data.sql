...
CREATE TABLE USER(USER_NAME VARCHAR(25) NOT NULL, PASSWORD VARCHAR(50) NOT NULL, PASSWORD_SALT VARCHAR(50) NOT NULL, FULL_NAME VARCHAR(50) NOT NULL, SESSION_ID VARCHAR(50));
